<template>
  <div class="login">
    <el-card class="el-card">
      ...
      <el-form ref="form" :model="loginForm" :rules="loginRules" style="margin-top:20px">
        ...
        <el-form-item>
          <el-checkbox :checked="false">我已阅读并同意用户协议和条款</el-checkbox>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    login () {
      // validator 是一个方法=》方法中传入的一个函数 两个校验参数
    }
  }
}
</script>
